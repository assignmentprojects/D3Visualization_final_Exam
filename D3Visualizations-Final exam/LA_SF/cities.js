document.write('<button id="Phosphates-P" class="Button" onclick="phosphates();">Phosphates-P</button>');
document.write('<button id="Floride" class="Button" onclick="floride();">Floride</button>');
document.write('<button id="Sulphate" class="Button" onclick="sulphate();">Sulphate</button>');
document.write('<button id="Nitrites" class="Button" onclick="nitrites();">Nitrites</button>');
document.write('<button id="Nitrates-N" class="Button" onclick="nitrates();">Nitrates-N</button>');
...
var canvas = d3.select("body").append("svg")
  ...
  d3.json("la.json", function(error, la) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var la_pop_value = data[i].phosphates;
        var la_housing_value = data[i].floride;
        var la_income_value = data[i].sulphate;
        var la_poverty_value = data[i].nitrites;
        var la_employment_value = data[i].nitrates;
...
d3.json("sf.json", function(error, sf) {
  ...
  for (var i = 0; i < data.length; i++) {
      var geoid_val = data[i].id2;
      var sf_pop_value = data[i].phosphates;
      var sf_housing_value = data[i].floride;
      var sf_income_value = data[i].sulphate;
      var sf_poverty_value = data[i].nitrites;
      var sf_employment_value = data[i].nitrates;
